    ...
    <section className={styles.heroSection}>
      <div className={styles.heroContent}>
        ...
        <div className={styles.heroDescription}>
          <p>This is a space where those facing challenges can connect with problem-solvers ready to help.</p>
          <p>Together, we foster collaboration, understanding, and impactful solutions to make a difference.</p>
          <p>Speak Up – Let’s Find Solutions Together</p>
        </div>
